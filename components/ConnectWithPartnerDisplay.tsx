...
export default function ConnectWithPartnerDisplay({user}: { user: User }) {
    return <View
        className="border-[1px] border-skip grow mb-8 rounded-xl bg-skip/10 p-4 space-y-3 justify-between">
        <View className="flex-row justify-around ">
            <Avatar ownership="main" url={user.avatar} text="You"/>
            <Avatar url={user.partner.avatar} text="Partner"/>
        </View>
        <View className="items-center">
            <Image className="w-[55vw] h-[40vw]" source={require("@/assets/illustrations/connect.png")}/>
