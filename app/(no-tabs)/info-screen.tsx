...
export default function InfoScreen(){
    ...
    return <SafeAreaWrapper>
        <Text classNames={{text:" mt-10 mb-8"}} type="h2">How to play?</Text>
        ...
        {/*</View>*/}
        <Button classNames={{wrapper:"mt-auto"}} iconPosition="right" onPress={()=>{router.push("/(no-tabs)/sign-up")}} title="Next"/>
    </SafeAreaWrapper>
}
